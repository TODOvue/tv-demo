...
export const demos: DemoVariant[] = [
  ...
  },
  {
    ...
    description:
      "This is a demo display for TODOvue components. Use this area to showcase the component's usage, props, variants, and live behavior in isolation.",
    html: IsDevComponent,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    propsData: {},
    description:
      'This demo showcases the support for multiple code variants (Vue 3 Setup, Vue 3 Options, Vue 2, TS).',
    html: Default,
    code: [
      {
        type: 'Vue 3 Setup',
